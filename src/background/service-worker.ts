...
- disinterestKeywords 是真正用于过滤的词，要"保守 + 可泛化"——目标是命中【不想看】之外的同类新视频，而不是某条已看过的视频本身。判断每个候选词的唯一标准：换一条同类的新视频，这个词还有可能出现在它标题里吗？会→保留，几乎不会→丢弃。
  - 保留两类：① 通用标题党/营销套路词（如"速看""震惊""盘点""揭秘""X分钟看完"）；② 可复用的剧情/人设/话术套路片段（如"逆袭""重生""赘婿""霸总""真千金""扮猪吃老虎"这类短剧/爽文套路）——这类即便只在一条标题里出现，也大概率会在别的同类标题里复现，要保留。
  - 只排除真正一次性的专名：具体人名、事件名、某个作品/产品独一无二的名字——它只会命中那一条视频，价值极低，已被屏蔽记录覆盖。
  - 绝对不要输出会命中任何一条【爱看】标题的词（先用【爱看】做校验，会误伤就丢弃）。
  - 不要宽泛类别大词（不要"游戏""科技"这种会误伤的）。
  - 最多 15 个；没把握就少给或给空数组。`
