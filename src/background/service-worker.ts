...
- disinterestKeywords 是真正用于过滤的词，要"保守 + 可泛化"——目标是命中【不想看】之外的同类新视频，而不是某条已看过的视频本身：
  - 优先提取会在多条不同【不想看】标题里复现的词，或通用的标题党/营销套路词（如"速看""震惊""盘点""揭秘""X分钟看完""全程高能"），以及反复出现的营销号/系列名。
  - 不要输出只出现在单条标题、且像是该视频独有的一次性专有名词（具体事件名、某个视频独特的主题词等）——这种词只会命中那一条，价值极低，已被屏蔽记录覆盖。
