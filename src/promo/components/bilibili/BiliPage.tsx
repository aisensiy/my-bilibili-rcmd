  ...
  return (
    <div style={{ padding: '20px 18px 18px', background: '#ffffff' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 24, height: 28, marginBottom: 16 }}>
        <div style={{ fontSize: 27, lineHeight: 1, fontWeight: 800, color: '#fb7299', marginRight: 10 }}>bilibili</div>
        {['首页', '番剧', '直播', '游戏中心', '会员购'].map(t => (
          <span key={t} style={{ fontSize: 13, fontWeight: 600, color: '#333845' }}>{t}</span>
        ))}
